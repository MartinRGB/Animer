...
import com.martinrgb.animer.math.converter.DHOConverter;
import com.martinrgb.animer.math.converter.OrigamiPOPConverter;
import com.martinrgb.animer.math.converter.RK4Converter;
import com.martinrgb.animer.math.converter.UIViewSpringConverter;
...
public class SpringSolver extends AnSolver {
    ...
    private SpringSolver(float stiffness,float dampingratio) {
