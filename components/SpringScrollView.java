...
//package com.example.martinrgb.dynamic_scroll.scrollview;
...
import com.example.martinrgb.dynamic_scroll.component.DynamicOverScroller;
...
public class SpringScrollView extends FrameLayout {
  ...
  // clampedY 回弹 init is 0.25f;
  static final float FOLLOW_HAND_FACTOR = 0.5f;
  ...
  public DynamicOverScroller mScroller;
  ...
  private void initScrollView() {
    mScroller = new DynamicOverScroller(getContext());
    mScroller.setRoundDecayScroll(true,969);
    //mScroller.setDynamicFlingFrictionState(true);
    setFocusable(true);
