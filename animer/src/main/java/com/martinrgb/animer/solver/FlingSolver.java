...
public class FlingSolver extends AnSolver {
    ...
    private FlingSolver(float velocity,float friction) {
    ...
    // ############################################
    // Fling Animation Solver's Converter
    // ############################################

    public static AnSolver createAndroidFling(float velocity,float friction){
        return new FlingSolver(velocity,friction);
    }
